...
const routes:RouteRecordRaw[]=[
  ...
  {path:'/',component:AppLayout,children:[
    ...
    {path:'admin/stats',component:()=>import('../features/analytics/DashboardPage.vue'),meta:{roles:['admin']}},
    {path:'admin/audit-events',component:()=>import('../features/analytics/AuditLogPage.vue'),meta:{roles:['admin']}},
